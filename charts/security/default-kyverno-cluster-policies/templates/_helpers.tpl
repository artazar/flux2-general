...
*/}}
{{- define "default-kyverno-cluster-policies.name" -}}
...
*/}}
{{- define "default-kyverno-cluster-policies.fullname" -}}
...
*/}}
{{- define "default-kyverno-cluster-policies.chart" -}}
...
Common labels
*/}}
{{- define "default-kyverno-cluster-policies.labels" -}}
helm.sh/chart: {{ include "default-kyverno-cluster-policies.chart" . }}
{{ include "default-kyverno-cluster-policies.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "default-kyverno-cluster-policies.selectorLabels" -}}
app.kubernetes.io/name: {{ include "default-kyverno-cluster-policies.name" . }}
...
*/}}
{{- define "default-kyverno-cluster-policies.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "default-kyverno-cluster-policies.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "default-kyverno-cluster-policies.APIServerAddress" -}}
